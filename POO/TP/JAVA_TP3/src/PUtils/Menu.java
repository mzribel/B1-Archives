...
import static PUtils.Menu_Class.classMenu;
...
public class Menu {
    ...
    public static void execute() {
        int userInput;
        String[] menuOptions = {"Importer une classe", "Créer une classe"};
        do {
            drawTitleBox(48, "M E N U  P R I N C I P A L", "JAVA | TP n°3");
            System.out.println();
            ...
            try {
                if (userInput == 1) {
                    ...
                    Class classData = fileID == 1 ? Class.readFromFile("exemple.json") : Class.readFromFile("data.json");
                    System.out.println();
                    classMenu(classData);
                } else if (userInput == 2) {
                    String userStr = Utils.getUserString("Quel nom donner à cette classe ?\n   → ", 1, 20);
                    System.out.println();
                    classMenu(new Class(userStr));
                }
            } catch (Exception e) {
